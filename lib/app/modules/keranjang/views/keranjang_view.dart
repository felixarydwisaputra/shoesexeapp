...
import 'package:shoesexe/main.dart';
                      ...
                      itemBuilder: (context, index) => Container(
                        ...
                        child:
                            StreamBuilder<
                                ...
                                stream: homeC.dataT(dataToko[index]["id_toko"]),
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            Text(
                                                                              "${homeC.rupiah.format(detail.harga)}",
                                                                              style: GoogleFonts.poppins(
                                                                                color: keempat,
                                                                                fontWeight: FontWeight.w500,
                                                                                fontSize: 10,
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      GetBuilder<HomescreenController>(
                                          builder: (c) {
                                        return Text(
                                          "${homeC.rupiah.format(totalK?["totalkeranjang"])}",
                                          style: GoogleFonts.poppins(
                                              fontWeight: FontWeight.w700,
                                              fontSize: 14),
                                        );
